...
object Datasets extends App {
  ...
  val guitarPlayerBandsDS: Dataset[(GuitarPlayer, Band)] = guitarPlayersDS.joinWith(bandsDS, guitarPlayersDS("band") === bandsDS("id"), "inner")
  ...
  guitarPlayersDS
    .joinWith(guitarsDS, array_contains(guitarPlayersDS("guitars"), guitarsDS("id")), "outer")
    .show()
