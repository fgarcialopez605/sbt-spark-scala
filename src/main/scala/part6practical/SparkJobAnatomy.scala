...
object SparkJobAnatomy extends App {
  ...
  // Aviso: El UI no está activo una vez que la App termina y el contexto se destruye
  // Lo que hay que hacer es anotar la dirección del UI, p.e., http://192.168.1.42:4041
  // y dejar la App ejecutándose para poder ver la UI, p.e. con Thread.sleep(1000000)
  ...
  // DEBUG - Dejar un tiempo ejecutando para poder ver el UI
  //Thread.sleep(1000000)

  // DEBUG - Salir en este punto para comprobar el resultado
  //System.exit(0)
